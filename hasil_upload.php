...
$st = new IDNstemmer();
$konek = mysqli_connect("localhost","root","","dbupload");
...
$tekspdf->decodePDF();
$isi = $tekspdf->output();
$query = "INSERT INTO upload (nama_file, deskripsi, isi, tgl_upload)
            VALUES('$nama_file', '$_POST[deskripsi]','$isi', '$tgl_upload')";
            
  mysqli_query($konek, $query);
//echo $tekspdf->output(); 
 preproses($isi,$nama_file);
